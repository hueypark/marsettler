...
#include "Message/MsgLoginReqBuilder.h"
#include "MessageHandler/MessageHandlers.h"
#include "Networking.h"

Connection::Connection() : m_stop(false), m_messageInHeaderBuf(8), m_messageOutHeaderBuf(8)
{
	m_socket = nullptr;
...
void Connection::WriteMessage(const MessageBuilder& builder)
{
...
void Connection::_CloseFromServer()
{
	if (!m_socket)
	{
		return;
...
bool Connection::_ConnectToServer()
{
