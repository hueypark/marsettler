...
pushd C:\Users\jaewa\go\src\github.com\hueypark\marsettler\Server\Package\mongo-cxx-driver-r3.6.2\stage\
...
echo Removing file lib\cmake\libbsoncxx-0.0.0\libbsoncxx-config.cmake
del lib\cmake\libbsoncxx-0.0.0\libbsoncxx-config.cmake || echo ... not removed
echo Removing file lib\cmake\libbsoncxx-0.0.0\libbsoncxx-config-version.cmake
del lib\cmake\libbsoncxx-0.0.0\libbsoncxx-config-version.cmake || echo ... not removed
...
echo Removing file lib\cmake\bsoncxx-0.0.0\bsoncxx_targets.cmake
del lib\cmake\bsoncxx-0.0.0\bsoncxx_targets.cmake || echo ... not removed
echo Removing file lib\cmake\bsoncxx-0.0.0\bsoncxx_targets-debug.cmake
del lib\cmake\bsoncxx-0.0.0\bsoncxx_targets-debug.cmake || echo ... not removed
echo Removing file lib\cmake\bsoncxx-0.0.0\bsoncxx-config-version.cmake
del lib\cmake\bsoncxx-0.0.0\bsoncxx-config-version.cmake || echo ... not removed
echo Removing file lib\cmake\bsoncxx-0.0.0\bsoncxx-config.cmake
del lib\cmake\bsoncxx-0.0.0\bsoncxx-config.cmake || echo ... not removed
...
echo Removing file lib\cmake\libmongocxx-0.0.0\libmongocxx-config.cmake
del lib\cmake\libmongocxx-0.0.0\libmongocxx-config.cmake || echo ... not removed
echo Removing file lib\cmake\libmongocxx-0.0.0\libmongocxx-config-version.cmake
del lib\cmake\libmongocxx-0.0.0\libmongocxx-config-version.cmake || echo ... not removed
...
echo Removing file lib\cmake\mongocxx-0.0.0\mongocxx_targets.cmake
del lib\cmake\mongocxx-0.0.0\mongocxx_targets.cmake || echo ... not removed
echo Removing file lib\cmake\mongocxx-0.0.0\mongocxx_targets-debug.cmake
del lib\cmake\mongocxx-0.0.0\mongocxx_targets-debug.cmake || echo ... not removed
echo Removing file lib\cmake\mongocxx-0.0.0\mongocxx-config-version.cmake
del lib\cmake\mongocxx-0.0.0\mongocxx-config-version.cmake || echo ... not removed
echo Removing file lib\cmake\mongocxx-0.0.0\mongocxx-config.cmake
del lib\cmake\mongocxx-0.0.0\mongocxx-config.cmake || echo ... not removed
...
echo Removing directory lib\cmake\bsoncxx-0.0.0
(rmdir lib\cmake\bsoncxx-0.0.0 2>NUL) || echo ... not removed (probably not empty)
echo Removing directory lib\cmake\libbsoncxx-0.0.0
(rmdir lib\cmake\libbsoncxx-0.0.0 2>NUL) || echo ... not removed (probably not empty)
echo Removing directory lib\cmake\libmongocxx-0.0.0
(rmdir lib\cmake\libmongocxx-0.0.0 2>NUL) || echo ... not removed (probably not empty)
echo Removing directory lib\cmake\mongocxx-0.0.0
(rmdir lib\cmake\mongocxx-0.0.0 2>NUL) || echo ... not removed (probably not empty)
...
cd ..
echo Removing top-level installation directory: C:\Users\jaewa\go\src\github.com\hueypark\marsettler\Server\Package\mongo-cxx-driver-r3.6.2\stage\
(rmdir C:\Users\jaewa\go\src\github.com\hueypark\marsettler\Server\Package\mongo-cxx-driver-r3.6.2\stage\ 2>NUL) || echo ... not removed (probably not empty)
